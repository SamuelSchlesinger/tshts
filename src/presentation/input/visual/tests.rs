...
// (e.g. `test_V_enters_visual_line`, `agent_visual_G_*`); the
// `Default::default()` + sequential field assignment pattern reads more
// clearly than struct literals for test setup with many fields.
